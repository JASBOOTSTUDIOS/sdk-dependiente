...
const char *const KEYWORDS[] = {
    ...
    "asociar_similitud", "asociar_diferencia", "buscar_asociados", "asociados_de", "buscar_asociados_lista", "asociados_lista_de",
    "vecinos_jmn", "vecinos_jmn_mai", "conexiones_salientes_de",
    "buscar_en_conceptos", "decae_conexiones", "decaer_conexiones", "consolidar_memoria", "dormir", "consolidar", "consolidar_sueno", "olvidar_debiles", "ventana_percepcion", "flujo_temporal", "percepcion_limpiar", "percepcion_tamano", "percepcion_anterior", "percepcion_recientes", "mai_contexto_recientes", "mai_contexto", "percepcion", "ventana_rastro_activacion", "rastro_activacion_ventana", "rastro_activacion_limpiar", "rastro_activacion_tamano", "rastro_activacion_obtener", "rastro_activacion_peso", "rastro_activacion_lista", "rastro_activacion_recientes", "propagar_activacion", "propagar_activacion_de", "propagar_activacion_semillas", "elegir_por_peso", "elegir_por_peso_segun", "elegir_por_peso_id", "elegir_por_peso_semilla", "elegir_por_peso_seed", "resolver_conflictos", "resolver_conflictos_de",
    "segmentar_palabras", "palabras_de", "dividir_texto", "tokenizar_L", "claves_L", "minusculas", "extraer_subtexto", "imprimir_id", "longitud_texto",
