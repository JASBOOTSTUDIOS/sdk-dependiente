...
const char *const SISTEMA_LLAMADAS[] = {
    ...
    "asociar_pesos_conceptos", "asociar_secuencia", "registrar_patron", "pensar_siguiente", "pensar_siguiente_mai",
    "pensar_anterior", "corregir_secuencia", "buscar_asociados_rango", "asociar_relacion", "asociar_relacion_mai", "comparar_patrones",
    "asociar_similitud", "asociar_diferencia", "buscar_asociados", "asociados_de",
    "buscar_asociados_lista", "buscar_asociados_lista_mai", "asociados_lista_de",
    "vecinos_jmn", "vecinos_jmn_mai", "conexiones_salientes_de",
    "buscar_en_memoria", "buscar_introspectiva",
    "buscar_en_memoria_lista", "buscar_en_memoria_cs", "buscar_en_memoria_detallada",
    "decae_conexiones", "decaer_conexiones",
    "consolidar_memoria", "dormir", "consolidar", "consolidar_sueno", "olvidar_debiles",
    "ventana_percepcion", "flujo_temporal", "percepcion_limpiar", "percepcion_tamano",
    "percepcion_anterior", "percepcion_recientes", "mai_contexto_recientes", "mai_contexto", "percepcion",
