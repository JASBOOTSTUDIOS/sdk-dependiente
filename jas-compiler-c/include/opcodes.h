...
#define OP_FS_ESCRIBIR_U32 0x65
#define OP_FS_LEER_ARCHIVO_REG 0x66
#define OP_FS_ESCRIBIR_ARCHIVO_REG 0x67
#define OP_FS_LEER_U32    0x68
...
#define OP_ANALITICA_MLP_PREDICT 0x73
#define OP_ANALITICA_MLP_SAVE 0x74
#define OP_MAI_CONTEXTO_LISTA 0x75
...
#define OP_MEM_MAPA_TAMANO 0x7E
...
#define OP_CARGAR_BIBLIOTECA 0x8F

#define OP_CONV_I2F       0x90
#define OP_CONV_F2I       0x91
#define OP_RAIZ           0x92
#define OP_FFI_OBTENER_SIMBOLO 0x93
#define OP_FFI_LLAMAR     0x94
#define OP_SIN            0x95
#define OP_COS            0x96
#define OP_TAN            0x97
#define OP_STR_DESDE_NUMERO 0x98
#define OP_ATAN2          0x99
#define OP_STR_DESDE_CODIGO 0x9A
#define OP_MAT4_MUL_VEC4  0x9B
#define OP_MAT4_MUL       0x9C
#define OP_EXP            0x9D
#define OP_LOG            0x9E
#define OP_LOG10          0x9F

#define OP_MAT4_IDENTIDAD 0xA0
#define OP_MAT4_TRANSPUESTA 0xA1
#define OP_MAT4_INVERSA   0xA2
#define OP_MAT3_MUL_VEC3  0xA3
#define OP_MAT3_MUL       0xA4
#define OP_MEM_REFORZAR_CONCEPTO 0xA5
#define OP_MEM_PENALIZAR_CONCEPTO 0xA6
#define OP_MEM_CONSOLIDAR_SUENO 0xA7
#define OP_MEM_OLVIDAR_DEBILES 0xA8
...
#define OP_STR_EXTRAER_ANTES 0xD0
#define OP_STR_EXTRAER_DESPUES 0xD1
#define OP_STR_CONCATENAR  0xD2
...
#define OP_MEM_BUSCAR_CONCEPTO 0xF1
#define OP_MEM_ASOCIAR_CONCEPTOS 0xF2
#define OP_MEM_ACTUALIZAR_PESO 0xF3
#define OP_MEM_OBTENER_ASOCIACIONES 0xF4
#define OP_MEM_OBTENER_RELACION 0xF5
#define OP_TLS_SERVIDOR    0xF6
#define OP_TLS_ENVIAR      0xF7
#define OP_TLS_RECIBIR     0xF8
#define OP_TLS_CERRAR      0xF9
#define OP_IO_PAUSA        0xFA
#define OP_FS_LEER_TEXTO   0xFB
#define OP_FS_ESCRIBIR_TEXTO 0xFC
#define OP_ACTIVAR_MODULO  0xFD
