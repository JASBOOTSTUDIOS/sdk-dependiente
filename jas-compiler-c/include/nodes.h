...
typedef struct {
    ...
    char **field_types;
    char **field_names;
    Visibility *field_visibilities; /* VISIBILITY_PUBLIC o VISIBILITY_PRIVATE para cada campo */
    size_t n_fields;
    ASTNode **methods;   /* FunctionNode* solo para clases; vacio en registro */
    size_t n_methods;
    int is_exported;     /* 1 si lleva `enviar` */
} StructDefNode;
