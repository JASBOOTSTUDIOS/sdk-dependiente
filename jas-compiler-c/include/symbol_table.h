...
#include <stddef.h>
#include <stdint.h>
#include "nodes.h" // Para Visibility enum
...
typedef struct SymbolEntry {
    ...
    Visibility visibility; /* VISIBILITY_PUBLIC o VISIBILITY_PRIVATE */
...
typedef struct SymbolTable {
    ...
    size_t scope_depth;
    const char *current_class_name; /* Nombre de la clase actual que se está resolviendo */
